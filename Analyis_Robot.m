%function [Fly] = Analyis_Robot(LH_Chord_Cut, LH_Span_Cut, RH_Chord_Cut, RH_Span_Cut, LH_Stroke_Amplitude, RH_Stroke_Amplitude, fly_num) 
%% Note on the Axese
...
%% Kinematic data
Kinematics_LH = Kin(Rotation_IntactWing(Period,1), Stroke_IntactWing(Period,1).*LH_Stroke_Amplitude/100, Deviation_IntactWing(Period,1), 0, dt);
