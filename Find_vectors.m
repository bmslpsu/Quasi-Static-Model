function [ex1, ey1, ez1, R_inv2]=Find_vectors(phi_f,alpha_f,gamma_f)
...
%% rotations
    ...
    Ry = [cosd(alpha_sym) 0 sind(alpha_sym);
          0 1 0;
              -sind(alpha_sym) 0 cosd(alpha_sym)];
    ...
    % Rx = [1 0 0;
    %       0 cosd(phi1) -sind(phi1);
    %       0 sind(phi1) cosd(phi1)];
    % 
    % Ry = [cosd(psi1) 0 sind(psi1);
    %       0 1 0;
    %       -sind(psi1) 0 cosd(psi1)];
    % 
    % Rz = [cosd(beta1) -sind(beta1) 0;
    %       sind(beta1) cosd(beta1) 0;
    %       0 0 1];
