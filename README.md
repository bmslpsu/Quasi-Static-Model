...
| +Utils/Analysis.m | 41 | Replace this entire section with a `Morphology` constructor |
| +Utils/Analysis.m | 65 | Rename Kin to something descriptive and unambiguous |
| +Utils/Analysis.m | 90 | Rewrite into a proper Dynamics constructor |
| +Utils/Analysis.m | 102 | Unpack Fly, every Fly_Master element should just be a struct of Kinematics, Morphology, Dynamics, time, Fly_Num, and Attributes |
