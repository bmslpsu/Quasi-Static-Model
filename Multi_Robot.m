...
%% Run Selector
runner = 1; % Wing Damage
%runner = 2; % Wing Storke

%% Wing Damage Values

if runner == 1
    Wing_damage_LH = 20:10:100;
    Wing_damage_RH = 100*ones(length(Wing_damage_LH),1);
    Stroke_Amplitude_LH = 100*ones(length(Wing_damage_LH),1);
    Stroke_Amplitude_RH = 100*ones(length(Wing_damage_LH),1);
end

%% Stroke Amplitude Values

if runner == 2
    Stroke_Amplitude_LH = 75:5:100;
    Stroke_Amplitude_RH = 100*ones(length(Stroke_Amplitude_LH),1);
    Wing_damage_LH = 100*ones(length(Stroke_Amplitude_LH),1);
    Wing_damage_RH = 100*ones(length(Stroke_Amplitude_LH),1);
end
